...
Report any failures with their tracebacks and suggest minimal fixes that respect the project's faithfulness conventions (see CLAUDE.md). Do **not** edit anything under `original/`.