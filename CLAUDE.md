...
Phase 8 so far: the scouting sweep, the map buffer, `GetNewsLine`, and now save/load (§8.4) with the message subsystem it depends on. What remains of it is the menus (§8.2), the status windows (§8.3) and the scenario front end (§8.5), plus the leftover UIs from Phases 4–6.
